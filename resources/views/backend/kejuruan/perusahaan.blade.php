        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Teknik Kendaraan Ringan
                <small>Kerja Sama</small>
                
              </h3>
              <a href="{{ route('kejuruan.create') }}" class="btn btn-primary btn-sm pull-right"><span class="fa fa-plus"></span> &nbsp &nbsp Tambah Perusahaan</a>
              <hr>
            </div>
            <!-- /.box-header -->
