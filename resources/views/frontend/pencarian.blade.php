            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
                      <div class="cta-text">
                        <h5><span class="fa fa-search"></span>&nbsp&nbsp&nbsp<b><i>Artikel Berjudul "{{$cari}}" Tidak Ditemukan</i></b></h5>
                      </div>
                    </div>
                    </div><br>
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
                      <div class="cta-text">
                        <h5><span class="fa fa-search"></span>&nbsp&nbsp&nbsp<b><i>Hasil Pencarian Artikel Berjudul "{{$cari}}"</i></b></h5>
                      </div>
                    </div>
                    </div><br>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                {!! Form::open(['url'=>url('/berita'), 'method'=>'post', 'class'=>'form-horizontal', 'role'=>'search']) !!}
                                    <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
