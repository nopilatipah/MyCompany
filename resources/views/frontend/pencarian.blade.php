...
@endphp
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            @if($jml == 0)
            <div class="alert alert-danger alert-light alert-dismissible" role="alert">Artikel Berjudul <b>"{{$cari}}"</b> Tidak Ditemukan</div>
            ...
            @if($jml > 0)
            <div class="alert alert-success alert-light alert-dismissible" role="alert">Hasil Pencarian Artikel Berjudul <b>"{{$cari}}"</b></div>
